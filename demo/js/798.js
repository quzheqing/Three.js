...
$(function () {
    ...
    function init() {
        ...
        mouse = new THREE.Vector2();/*新建一个Vector2对象保存鼠标位置信息*/
                ...
                for (var i = 0; i < object.children.length; i++) {
                    ...
                    if (object.children[i].name.indexOf("Sphere") != -1) {
                        ...
                        if (markFlag) {
                            ...
                            sprite2.position.set(setp.x, setp.y + 20, setp.z);
                            scene.add(sprite2);
                            markFlag = false;
                            //设置动画路线
                            var tween = createjs.Tween.get(sprite2.position)
                                .to({x: 52.919898986816406, y: 22.934100031852722, z: -78.66939926147461}, 5000)
                                .to({x: 52.202951431274414, y: 22.934100031852722, z: -44.81830024719238}, 5000)
                                .to({x: 39.74650001525879, y: 22.934100031852722, z: -44.07609939575195}, 2000)
                                .to({x: 35.96610069274902, y: 22.934100031852722, z: -3.103700041770935}, 5000)
                                .to({x: -47.70665168762207, y: 22.934100031852722, z: -1.6300000250339508}, 5000)
                                .to({x: -49.70979881286621, y: 22.934100031852722, z: 30.858500480651855}, 5000)
                                .to({x: -68.47019958496094, y: 22.934100031852722, z: 34.66460037231445}, 5000)
                                .to({x: -82.04104995727539, y: 22.934100031852722, z: 2.759750008583069}, 5000)
                                .to({x: -106.0634994506836, y: 22.934100031852722, z: -0.2046000063419342}, 5000)
                            console.log(sprite2);
                        }
                    }
                }
